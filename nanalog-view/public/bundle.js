...
/***/ function(module, exports, __webpack_require__) {
	...
	var _diary = __webpack_require__(7);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js!!./customBase.css", function() {
				var newContent = require("!!./../../../node_modules/css-loader/index.js!!./customBase.css");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports) {
	...
	(function () {
	    ...
	    diaryService.prototype = {
	        ...
	        displayInitEventHandler: function displayInitEventHandler() {},
	        run: function run() {}
	    };
